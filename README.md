...
- **Contributing to open-source** in my tech stack (Angular, Python, TypeScript).  
- **Prioritizing work-life balance** (nature, fitness, gaming) to stay energized.  
...
- **Mindset:** Balancing code + self-care (gaming, hiking 🏞️).
